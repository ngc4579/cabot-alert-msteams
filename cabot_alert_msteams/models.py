...
class MSTeamsAlert(AlertPlugin):
    ...
    def _send_msteams_alert(self, message, service_name, color='green', sender='Cabot'):
        ...
        resp = requests.post(url, data={
            ...
            '@type': 'MessageCard',
            'summary': service_name + ' status',
            'themeColor': 'ff0000',
            'title': service_name + ' alert',
            'sections': [
                {
                    'activityTitle': '**Alert generated by ' + sender + '.**',
                    'activitySubtitle': 'from ' + service_name,
                    'facts': [
                        {
                            "name": "Message",
                            "value": message
